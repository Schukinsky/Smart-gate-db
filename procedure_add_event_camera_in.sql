CREATE OR REPLACE PROCEDURE gate01.add_event_camera_in(
...
--CALL gate01.add_event_camera_in('Р686СК000');
--CALL gate01.add_event_camera_in('Р686СК000', 'http://fileserver.org/images/img_0000000001.jpg');